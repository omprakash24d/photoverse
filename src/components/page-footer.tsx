...
import { Instagram, Twitter, Linkedin, Github } from 'lucide-react'; // Added Instagram, Pinterest

export function PageFooter() {
  const developerLinkedIn = "https://www.linkedin.com/in/omrakash24d/";
  const developerGithub = "https://github.com/omprakash24d";
  const developerTwitter = "https://twitter.com/omprakash25d";
